...
typedef struct
{
  ...
  uint16_t TMR_Plus;              /*!< Specifies the timer plus mode.
																			 This parameter can be a value of@ref TMR_Plus_Switch */
...
/** @defgroup TMR_Plus_Switch
  * @{
  */

#define TMR_Plus_Enable			              ((uint16_t)0x0400)
#define TMR_Plus_Disable		              ((uint16_t)0x0000)
#define IS_TMR_PLUS_SWITCH(PLUS)          (((PLUS) == TMR_Plus_Enable)||\
                                           ((PLUS) == TMR_Plus_Disable))
